...
@Name("std::unordered_map<size_t,cv::detail::tracking::tbm::Track>") @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.opencv.presets.opencv_tracking.class)
