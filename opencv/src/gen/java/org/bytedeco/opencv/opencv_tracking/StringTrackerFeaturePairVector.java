...
@Name("std::vector<std::pair<cv::String,cv::Ptr<cv::TrackerFeature> > >") @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.opencv.presets.opencv_tracking.class)
