...
public class opencv_imgproc extends com.oracle.svm.shadowed.org.bytedeco.opencv.presets.opencv_imgproc {
    ...
    public static int cvFindContours(CvArr image, CvMemStorage storage, CvSeq first_contour,
        ...
        return com.oracle.svm.shadowed.org.bytedeco.opencv.global.opencv_imgproc.cvFindContours(image, storage, first_contour, header_size, mode, method, CvPoint.ZERO);
    }

    public static CvContourScanner cvStartFindContours(CvArr image, CvMemStorage storage,
            int header_size/*=sizeof(CvContour)*/, int mode/*=CV_RETR_LIST*/, int method/*=CV_CHAIN_APPROX_SIMPLE*/) {
        return com.oracle.svm.shadowed.org.bytedeco.opencv.global.opencv_imgproc.cvStartFindContours(image, storage, header_size, mode, method, CvPoint.ZERO);
    }

    public static CvHistogram cvCreateHist(int dims, int[] sizes, int type,
            float[][] ranges/*=null*/, int uniform/*=1*/) {
        return com.oracle.svm.shadowed.org.bytedeco.opencv.global.opencv_imgproc.cvCreateHist(dims, new IntPointer(sizes), type,
    ...
    public static void cvSetHistBinRanges(CvHistogram hist,
        ...
        com.oracle.svm.shadowed.org.bytedeco.opencv.global.opencv_imgproc.cvSetHistBinRanges(hist,
                ranges == null ? null : new PointerPointer(ranges), uniform);
    }
    ...
    public static CvHistogram cvMakeHistHeaderForArray(int dims, int[] sizes, CvHistogram hist,
        ...
        return com.oracle.svm.shadowed.org.bytedeco.opencv.global.opencv_imgproc.cvMakeHistHeaderForArray(dims, new IntPointer(sizes), hist,
    ...
    public static void cvCalcArrHist(CvArr[] arr, CvHistogram hist, int accumulate/*=0*/, CvArr mask/*=null*/) {
        com.oracle.svm.shadowed.org.bytedeco.opencv.global.opencv_imgproc.cvCalcArrHist(new CvArrArray(arr), hist, accumulate, mask);
    }
    public static void cvCalcHist(IplImage[] arr, CvHistogram hist, int accumulate/*=0*/, CvArr mask/*=null*/) {
        com.oracle.svm.shadowed.org.bytedeco.opencv.global.opencv_imgproc.cvCalcHist(new IplImageArray(arr), hist, accumulate, mask);
    }
    public static void cvCalcHist(IplImageArray arr, CvHistogram hist,
            int accumulate/*=0*/, CvArr mask/*=null*/) {
        com.oracle.svm.shadowed.org.bytedeco.opencv.global.opencv_imgproc.cvCalcArrHist(arr, hist, accumulate, mask);
    }

    public static void cvCalcArrBackProject(CvArr[] image, CvArr dst, CvHistogram hist) {
        com.oracle.svm.shadowed.org.bytedeco.opencv.global.opencv_imgproc.cvCalcArrBackProject(new CvArrArray(image), dst, hist);
    }
    public static void cvCalcBackProject(IplImage[] image, CvArr dst, CvHistogram hist) {
        com.oracle.svm.shadowed.org.bytedeco.opencv.global.opencv_imgproc.cvCalcBackProject(new IplImageArray(image), dst, hist);
    }
    public static void cvCalcBackProject(IplImageArray image,
            CvArr dst, CvHistogram hist) {
        com.oracle.svm.shadowed.org.bytedeco.opencv.global.opencv_imgproc.cvCalcArrBackProject(image, dst, hist);
    }

    public static void cvCalcArrBackProjectPatch(CvArr[] image,
            CvArr dst, CvSize range, CvHistogram hist, int method, double factor) {
        com.oracle.svm.shadowed.org.bytedeco.opencv.global.opencv_imgproc.cvCalcArrBackProjectPatch(new CvArrArray(image), dst, range, hist, method, factor);
    }
    public static void cvCalcBackProjectPatch(IplImage[] image,
            CvArr dst, CvSize range, CvHistogram hist, int method, double factor) {
        com.oracle.svm.shadowed.org.bytedeco.opencv.global.opencv_imgproc.cvCalcBackProjectPatch(new IplImageArray(image), dst, range, hist, method, factor);
    }
    public static void cvCalcBackProjectPatch(IplImageArray image,
            CvArr dst, CvSize range, CvHistogram hist, int method, double factor) {
        com.oracle.svm.shadowed.org.bytedeco.opencv.global.opencv_imgproc.cvCalcArrBackProjectPatch(image, dst, range, hist, method, factor);
    }

    public static void cvFillPoly(CvArr img, CvPoint[] pts, int[] npts,
            int contours, CvScalar color, int line_type/*=8*/, int shift/*=0*/) {
        com.oracle.svm.shadowed.org.bytedeco.opencv.global.opencv_imgproc.cvFillPoly(img, new PointerPointer(pts),
    ...
    public static void cvPolyLine(CvArr img, CvPoint[] pts,
        ...
        com.oracle.svm.shadowed.org.bytedeco.opencv.global.opencv_imgproc.cvPolyLine(img, new PointerPointer(pts),
    ...
    public static void cvDrawContours(CvArr img, CvSeq contour, CvScalar external_color,
        ...
        com.oracle.svm.shadowed.org.bytedeco.opencv.global.opencv_imgproc.cvDrawContours(img, contour, external_color,
