...
[![Gitter](https://badges.gitter.im/bytedeco/javacpp.svg)](https://gitter.im/bytedeco/javacpp) [![Maven Central](https://maven-badges.herokuapp.com/maven-central/com.oracle.svm.shadowed.org.bytedeco/gym/badge.svg)](https://maven-badges.herokuapp.com/maven-central/com.oracle.svm.shadowed.org.bytedeco/gym) [![Sonatype Nexus (Snapshots)](https://img.shields.io/nexus/s/https/oss.sonatype.org/com.oracle.svm.shadowed.org.bytedeco/gym.svg)](http://bytedeco.org/builds/)  
...
<project>
    ...
    <groupId>com.oracle.svm.shadowed.org.bytedeco.gym</groupId>
...
public class ListEnvs {
    public static void main(String[] args) throws Exception {
        ...
        Py_Initialize(com.oracle.svm.shadowed.org.bytedeco.gym.presets.gym.cachePackages());
        if (_import_array() < 0) {
