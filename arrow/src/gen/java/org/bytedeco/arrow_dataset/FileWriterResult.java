...
@Name("arrow::Result<std::shared_ptr<arrow::dataset::FileWriter> >") @NoOffset @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.arrow.presets.arrow_dataset.class)
