...
@Name("arrow::Iterator<std::unique_ptr<arrow::dataset::ScanTask> >") @NoOffset @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.arrow.presets.arrow_dataset.class)
