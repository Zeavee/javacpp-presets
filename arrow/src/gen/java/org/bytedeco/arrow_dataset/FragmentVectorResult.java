...
@Name("arrow::Result<std::vector<std::shared_ptr<arrow::dataset::Fragment> > >") @NoOffset @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.arrow.presets.arrow_dataset.class)
