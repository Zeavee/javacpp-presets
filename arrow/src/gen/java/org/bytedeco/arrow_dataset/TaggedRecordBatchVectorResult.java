...
@Name("arrow::Result<std::vector<arrow::dataset::TaggedRecordBatch> >") @NoOffset @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.arrow.presets.arrow_dataset.class)
