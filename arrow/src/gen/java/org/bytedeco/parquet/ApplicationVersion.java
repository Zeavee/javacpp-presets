...
public class ApplicationVersion extends Pointer {
  ...
  public native @Cast("bool") boolean HasCorrectStatistics(com.oracle.svm.shadowed.org.bytedeco.parquet.Type.type primitive, @ByRef EncodedStatistics statistics,
                              com.oracle.svm.shadowed.org.bytedeco.parquet.SortOrder.type sort_order/*=parquet::SortOrder::SIGNED*/);
  public native @Cast("bool") boolean HasCorrectStatistics(com.oracle.svm.shadowed.org.bytedeco.parquet.Type.type primitive, @ByRef EncodedStatistics statistics);
