...
@NoOffset @Name("std::pair<std::string,std::shared_ptr<arrow::flight::ServerMiddlewareFactory> >") @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.arrow.presets.arrow_flight.class)
