...
@Name("std::vector<std::shared_ptr<arrow::flight::ClientMiddlewareFactory> >") @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.arrow.presets.arrow_flight.class)
