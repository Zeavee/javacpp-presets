...
@Name("arrow::Result<std::unique_ptr<arrow::compute::FunctionOptions> >") @NoOffset @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.arrow.presets.arrow.class)
