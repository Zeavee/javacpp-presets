...
@Name("arrow::Result<std::shared_ptr<arrow::compute::SelectionVector> >") @NoOffset @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.arrow.presets.arrow.class)
