...
@Name("arrow::Result<std::shared_ptr<const arrow::KeyValueMetadata> >") @NoOffset @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.arrow.presets.arrow.class)
