...
package com.oracle.svm.shadowed.org.bytedeco.arrow.global;
...
public class parquet extends com.oracle.svm.shadowed.org.bytedeco.arrow.presets.parquet {
    static { Loader.load(); }
...
@Namespace("parquet") public static native @StdString String TypeToString(com.oracle.svm.shadowed.org.bytedeco.parquet.Type.type t);
@Namespace("parquet") public static native @StdString BytePointer TypeToString(@Cast("parquet::Type::type") int t);

@Namespace("parquet") public static native int GetTypeByteSize(com.oracle.svm.shadowed.org.bytedeco.parquet.Type.type t);
@Namespace("parquet") public static native int GetTypeByteSize(@Cast("parquet::Type::type") int t);

@Namespace("parquet") public static native com.oracle.svm.shadowed.org.bytedeco.parquet.SortOrder.type DefaultSortOrder(com.oracle.svm.shadowed.org.bytedeco.parquet.Type.type primitive);
...
@Namespace("parquet") public static native com.oracle.svm.shadowed.org.bytedeco.parquet.SortOrder.type GetSortOrder(ConvertedType.type converted,
                                            com.oracle.svm.shadowed.org.bytedeco.parquet.Type.type primitive);
...
@Namespace("parquet") public static native com.oracle.svm.shadowed.org.bytedeco.parquet.SortOrder.type GetSortOrder(
    @Const @Cast("const parquet::LogicalType*") @SharedPtr @ByRef LogicalType logical_type, com.oracle.svm.shadowed.org.bytedeco.parquet.Type.type primitive);
