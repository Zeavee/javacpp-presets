...
@Name("arrow::Result<std::shared_ptr<arrow::ipc::RecordBatchWriter> >") @NoOffset @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.arrow.presets.arrow.class)
