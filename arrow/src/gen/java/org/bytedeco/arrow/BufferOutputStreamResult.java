...
@Name("arrow::Result<std::shared_ptr<arrow::io::BufferOutputStream> >") @NoOffset @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.arrow.presets.arrow.class)
