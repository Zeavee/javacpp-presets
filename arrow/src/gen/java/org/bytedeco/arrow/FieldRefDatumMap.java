...
@Name("std::unordered_map<arrow::FieldRef,arrow::Datum,arrow::FieldRef::Hash>") @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.arrow.presets.arrow.class)
