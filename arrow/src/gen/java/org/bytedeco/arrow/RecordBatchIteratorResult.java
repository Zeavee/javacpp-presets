...
@Name("arrow::Result<arrow::Iterator<std::shared_ptr<arrow::RecordBatch> > >") @NoOffset @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.arrow.presets.arrow.class)
