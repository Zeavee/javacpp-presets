...
public class EqualOptions extends Pointer {
  ...
  public native @Cast("bool") @com.oracle.svm.shadowed.org.bytedeco.javacpp.annotation.Function boolean nans_equal();

  /** Return a new EqualOptions object with the "nans_equal" property changed. */
  public native @ByVal @com.oracle.svm.shadowed.org.bytedeco.javacpp.annotation.Function EqualOptions nans_equal(@Cast("bool") boolean v);

  /** The absolute tolerance for approximate comparisons of floating-point values. */
  public native @com.oracle.svm.shadowed.org.bytedeco.javacpp.annotation.Function double atol();

  /** Return a new EqualOptions object with the "atol" property changed. */
  public native @ByVal @com.oracle.svm.shadowed.org.bytedeco.javacpp.annotation.Function EqualOptions atol(double v);

  /** The ostream to which a diff will be formatted if arrays disagree.
   *  If this is null (the default) no diff will be formatted. */
  public native @Cast("std::ostream*") @com.oracle.svm.shadowed.org.bytedeco.javacpp.annotation.Function Pointer diff_sink();
   ...
   *  not supported. */
  public native @ByVal @com.oracle.svm.shadowed.org.bytedeco.javacpp.annotation.Function EqualOptions diff_sink(@Cast("std::ostream*") Pointer diff_sink);
