...
@Name("arrow::Future<std::shared_ptr<arrow::ipc::RecordBatchFileReader> >") @NoOffset @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.arrow.presets.arrow.class)
