...
package com.oracle.svm.shadowed.org.bytedeco.mkl.presets;
 ...
 * @author Samuel Audet
 */
@Properties(inherit = javacpp.class, global = "com.oracle.svm.shadowed.org.bytedeco.mkl.global.mkl_rt", names = {"linux-x86", "macosx-x86", "windows-x86"}, value = {
...
public class mkl_rt implements InfoMapper {
    static { Loader.checkVersion("com.oracle.svm.shadowed.org.bytedeco", "mkl"); }
