...
@Name("std::vector<std::pair<tensorflow::string,tensorflow::string> >") @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.tensorflow.presets.tensorflow.class)
