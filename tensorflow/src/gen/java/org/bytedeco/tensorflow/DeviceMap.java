...
@Name("tensorflow::gtl::FlatMap<tensorflow::string,tensorflow::Device*,StringPieceHasher>") @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.tensorflow.presets.tensorflow.class)
