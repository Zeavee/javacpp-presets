...
@Name("std::vector<std::pair<tensorflow::TensorHandle*,TF_Output> >") @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.tensorflow.presets.tensorflow.class)
