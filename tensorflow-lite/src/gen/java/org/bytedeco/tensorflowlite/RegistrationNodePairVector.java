...
@Name("std::vector<std::pair<TfLiteNode,TfLiteRegistration> >") @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.tensorflowlite.presets.tensorflowlite.class)
