...
@Name("std::unordered_map<std::int32_t,std::unique_ptr<tflite::resource::ResourceBase> >") @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.tensorflowlite.presets.tensorflowlite.class)
