...
@Name("torch::jit::detail::NamedPolicy<torch::jit::detail::ParameterPolicy>") @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.pytorch.presets.torch.class)
