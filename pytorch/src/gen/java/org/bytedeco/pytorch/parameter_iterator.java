...
@Name("torch::jit::slot_iterator_impl<torch::jit::detail::ParameterPolicy>") @NoOffset @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.pytorch.presets.torch.class)
