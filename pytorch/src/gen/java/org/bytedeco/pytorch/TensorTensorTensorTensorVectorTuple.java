...
@NoOffset @Name("std::tuple<at::Tensor,at::Tensor,at::Tensor,std::vector<at::Tensor> >") @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.pytorch.presets.torch.class)
