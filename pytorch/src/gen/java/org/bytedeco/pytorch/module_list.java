...
@Name("torch::jit::slot_list_impl<torch::jit::detail::ModulePolicy>") @NoOffset @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.pytorch.presets.torch.class)
