...
@Namespace("mkldnn") @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.mkldnn.presets.mkldnn.class)
public class convolution_forward extends primitive {
    ...
    public static class primitive_desc extends com.oracle.svm.shadowed.org.bytedeco.mkldnn.primitive_desc {
        static { Loader.load(); }
        /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
