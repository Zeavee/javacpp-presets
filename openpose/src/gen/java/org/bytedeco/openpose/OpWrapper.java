...
import static com.oracle.svm.shadowed.org.bytedeco.openpose.global.openpose.*;
     ...
     */
    @Name("op::WrapperT<op::Datum,std::vector<std::shared_ptr<op::Datum> >,std::shared_ptr<std::vector<std::shared_ptr<op::Datum> > >,std::shared_ptr<op::Worker<std::shared_ptr<std::vector<std::shared_ptr<op::Datum> > > > > >") @NoOffset @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.openpose.presets.openpose.class)
