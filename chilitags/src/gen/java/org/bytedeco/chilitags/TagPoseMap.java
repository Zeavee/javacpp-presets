...
@Name("std::map<std::string,chilitags::Chilitags3D_<float>::TransformMatrix>") @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.chilitags.presets.chilitags.class)
