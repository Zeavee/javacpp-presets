...
@Namespace("dnnl") @Properties(inherit = com.oracle.svm.shadowed.org.bytedeco.dnnl.presets.dnnl.class)
public class primitive extends dnnl_primitive_handle {
    ...
    ///
    public primitive(@Const @ByRef com.oracle.svm.shadowed.org.bytedeco.dnnl.primitive_desc pd) { super((Pointer)null); allocate(pd); }
    private native void allocate(@Const @ByRef com.oracle.svm.shadowed.org.bytedeco.dnnl.primitive_desc pd);
